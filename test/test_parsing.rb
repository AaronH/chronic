...
class TestParsing < Test::Unit::TestCase
  ...
  def test_handle_rmn_sd
    ...
    assert_equal Time.local(2007, 1, 5, 13, 0, 0), time
  end
  ...
  def test_handle_rmn_sy
    ...
    time = parse_now("may 40", :ambiguous_year_future_bias => 80)
  ...
  def test_handle_rmn_sd_sy
    ...
    time = parse_now("may 27 40", :ambiguous_year_future_bias => 80)
    assert_equal Time.local(1940, 5, 27, 12, 0, 0), time
  end
